...
define(['jquery'], function ($) {
	...
	window.Set_TDKCDJJSSMS_value = function (_data) {
		...
		$('[name=HZ9180927227809801723b0714d41f18_ZBX]').val(_data.tylx)
		...
		$('[name=HZ9180927227809801723b0714d41f18_ZBX]').val(_data.jldw)
		...
		$('[name=HZ9180927227809801723b0714d41f18_ZBX]').val(_data.jdfd)
		...
		$('[name=HZ9180927227809801723b0714d41f18_XXZ]').val(zhcs[4]);
		$('[name=HZ9180927227809801723b0714d41f18_YXZ]').val(zhcs[5]);
		$('[name=HZ9180927227809801723b0714d41f18_ZXZ]').val(zhcs[6]);
