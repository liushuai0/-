        ...
        function init() {
            ...
            _this.$api.dict({ "type": "DKYT" }, function (data) {
                ...
                for (var i = 0; i < data.dataList.length; i++) {
                    ...
                    _this.$el.find("#dkyt").append('<option value="' + item.dictValue + '" >' + item.dictValue + '</option>');
                }
                form.render();//渲染下拉框
            }, function () {
            ...
            _this.$api.dict({ "type": "TXLX" }, function (data) {
                ...
                for (var i = 0; i < data.dataList.length; i++) {
                    var item = data.dataList[i];
                    _this.$el.find("#txlx").append('<option value="' + item.dictValue + '" >' + item.dictValue + '</option>');
                }
                form.render();//渲染下拉框
            }, function () {
