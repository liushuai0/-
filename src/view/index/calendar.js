 ...
 var calendar = function (parent) {
    ...
    this.pre.click(function () {
        ...
        // _this.renderDayslist(year, month, _this.parent.options.canclickbefore);
    });
    this.gotoToday.click(function () {
        _this.yearList.css('display', 'none');
        _this.daysList.css('display', 'block');
        // _this.renderDayslist(_this.today.year, _this.today.month, _this.parent.options.canclickbefore);
    });
