...
var dict = function (data, success, error) {
    request.post({
        url: "/natureResource/dictmanage/getDictByType",
        query: data,
        async: false,
...
var queryTdflmjbCollectModelForList = function (data, success, error) {
    request.post({
        url: "/natureResource/sjbp/queryTdflmjbCollectModelForList",
        query: data,
        async: false,
        devUrl: 'affairService',
        success: function (res) {
...
var deleteDkxxbById = function (data, success, error) {
    request.post({
        url: "/natureResource/sjbp/deleteDkxxbById",
        query: data,
        async: false,
        devUrl: 'affairService',
        success: function (res) {
...
var deleteAllDkxxbById = function (data, success, error) {
    request.post({
        url: "/natureResource/sjbp/deleteAllDkxxbById",
        query: data,
        async: false,
        devUrl: 'affairService',
        success: function (res) {
...
var deleteDkzbbById = function (data, success, error) {
    request.post({
        url: "/natureResource/sjbp/deleteDkzbbById",
        query: data,
        async: false,
        devUrl: 'affairService',
        success: function (res) {
...
var deleteAllDkzbbById = function (data, success, error) {
    request.post({
        url: "/natureResource/sjbp/deleteAllDkzbbById",
        query: data,
        async: false,
        devUrl: 'affairService',
        success: function (res) {
...
var findDkxxbInfo = function (data, success, error) {
    request.post({
        url: "/natureResource/sjbp/findDkxxbInfo",
        query: data,
        async: false,
        devUrl: 'affairService',
        success: function (res) {
...
var insertDkxxbInfo = function (data, success, error) {
    request.post({
        url: "/natureResource/sjbp/insertDkxxbInfo",
        query: data,
        async: false,
        devUrl: 'affairService',
        success: function (res) {
...
var updateDkxxbById = function (data, success, error) {
    request.post({
        url: "/natureResource/sjbp/updateDkxxbById",
        query: data,
        async: false,
        devUrl: 'affairService',
        success: function (res) {
...
var insertDkzbbInfo = function (data, success, error) {
    request.post({
        url: "/natureResource/sjbp/insertDkzbbInfo",
        query: data,
        async: false,
        devUrl: 'affairService',
        success: function (res) {
...
var updateDkzbbById = function (data, success, error) {
    request.post({
        url: "/natureResource/sjbp/updateDkzbbById",
        query: data,
        async: false,
        devUrl: 'affairService',
        success: function (res) {
...
var getProjectInfo = function (data, success) {
    request.get({
        url: '/natureResource/surve/getProjectInfo',
        query: {
            projectNo: data
        },
        devUrl: 'affairService',
...
var getFlowInfo = function (data, success) {
    request.get({
        url: '/natureResource/surve/getFlowInfo',
        query: {
            projectNo: data
        },
        devUrl: 'affairService',
...
var ZipFiles = function (data, success) {
    request.get({
        url: '/natureResource/surve/ZipFiles',
        query: {
            projectNo: data,
...
var isImport = function (data, success, error) {
    request.post({
        url: "/natureResource/sjbp/isImport",
        query: data,
        async: false,
        devUrl: 'affairService',
        success: function (res) {
